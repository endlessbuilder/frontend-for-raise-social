...
import { ChevronDown, Bold, Italic, Link, AlignLeft, List, ListOrdered, Image, Quote, Calendar } from 'lucide-react';
...
const RichTextEditor = ({ placeholder }) => {
    ...
    const handleEditorChange = (state) => {
        ...
        const blockType = state.getCurrentContent()
    ...
    return (
        <div className="border border-gray-300 rounded-md shadow-sm">
            <div className="flex items-center p-2 border-b border-gray-200 flex-wrap">
                ...
                <button onClick={() => onBlockClick('unordered-list-item')} className="p-1 rounded hover:bg-gray-100">
                    <List className="w-4 h-4" />
                </button>
                <button onClick={() => onBlockClick('ordered-list-item')} className="p-1 rounded hover:bg-gray-100">
