...
const page = () => {
    return (
        <>
            ...
            <p className='text-lg font-bold text-brand-dark mb-12'>We have sent an one time password on your email address, fill it
                in below and move to the next step.</p>
            <p className='text-lg font-bold text-brand-dark mb-4'>One Time Password</p>
            <InputOTP containerClassName="w-full mb-12" maxLength={6}
