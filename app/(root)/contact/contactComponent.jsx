...
const ContactForm = () => (
    <form className="bg-brand-lemon-yellow p-8">
        ...
        <p className="text-xl mb-6">
            If you have any questions or queries feel free to fill this form. Our team will respond to your message within a short period of time.
        </p>
        ...
        <div className="grid grid-cols-2 mb-5 gap-5">
            <Input size='lg' variant="bordered" label="First Name" type='text' radius='sm' classNames={{
                inputWrapper: "border border-brand-dark"
            }} />
            <Input size='lg' variant="bordered" label="Last Name" type='text' radius='sm' classNames={{
                inputWrapper: "border border-brand-dark"
            }} />
        </div>
        <Textarea
        ...
        <div className="flex justify-end">
            <Button variant='bordered' radius='full' size='lg' className='font-medium text-brand-dark border-brand-dark xl:py-6 xl:px-7'
            >
                Submit
            </Button>
        </div>
