...
const TabButton = ({ active, children }) => (
    <button
        className={`px-5 py-3 rounded-full text-sm font-bold transition-colors ${active
...
function DonationsComponent() {
    const donations = [
        ...
        {
            avatar: "https://cdn.builder.io/api/v1/image/assets/TEMP/9630c9c04493435b7221eba734c2455d9825b10880c8307ff9f33c3784b84660",
            name: "Anonymous User",
            amount: "24",
            time: "2 days ago"
        },
        {
            avatar: "https://cdn.builder.io/api/v1/image/assets/TEMP/8d86b4b91cc4fb1a3699a4d98d06f4f0582853ead6a3695d56fa6e6c0a9c5c30",
