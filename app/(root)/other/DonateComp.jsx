...
const DonationForm = () => (
    <form>
        <div className="mb-4">
            <button type="button" className="w-full p-4 flex justify-between items-center rounded-lg border border-stone-700 text-xl font-bold text-stone-700">
                Connect Wallet
                <span className="material-icons">account_balance_wallet</span>
            </button>
        </div>
        <div className="mb-4">
            <label htmlFor="donationAmount" className="sr-only">Donation Amount</label>
        ...
        <ConsentCheckboxes />
        <button type="submit" className="w-full py-3.5 mt-4 text-sm font-bold border border-stone-700 rounded-full text-stone-700">
            Donate Now
        </button>
    </form>
);
...
const ConsentCheckboxes = () => (
    <fieldset className="mb-4">
        ...
        <div className="flex items-center mb-2">
            ...
            <label htmlFor="anonymousDonation" className="text-base font-bold tracking-wider text-stone-700">
                Don't display my name publicly on the fundraiser.
            </label>
        </div>
        <div className="flex items-center">
            <input type="checkbox" id="marketingConsent" className="mr-2" />
            <label htmlFor="marketingConsent" className="text-base font-bold tracking-wider text-stone-700">
