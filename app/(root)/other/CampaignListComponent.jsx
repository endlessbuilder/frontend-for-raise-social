...
const FilterSection = () => (
    <section className="flex flex-wrap gap-2 mt-7 text-base font-bold text-stone-700">
        <FilterButton label="Category" icon="https://cdn.builder.io/api/v1/image/assets/TEMP/31beb790828a3f42a470f2bd19e2ad707fb9b193c42723ef663f0efc324a0753" />
        <FilterButton label="Close to goal" icon="https://cdn.builder.io/api/v1/image/assets/TEMP/f0661d16d72b07aff81cbdbe915cc912656774658fe96b306711ce4b3959add4" />
        <SearchButton />
    </section>
);
    ...
    <article className="flex gap-5">
        ...
        <div className="flex-1">
            ...
            <div className="flex gap-1.5 mt-3.5 text-sm font-bold">
                <ActionButton label="Edit" icon="https://cdn.builder.io/api/v1/image/assets/TEMP/8625ca56f29f59699991011c4fc201619ea99d62c7578481ae856563a9fde052" />
                <ActionButton label="View" icon="https://cdn.builder.io/api/v1/image/assets/TEMP/ffdd7597123ffc9d10d0fd934db1e42628cb4430c63c6bf659e29eb31f1a4e2c" />
                <ActionButton label="Share" icon="https://cdn.builder.io/api/v1/image/assets/TEMP/bd0d3c016418a4b43cfc53e9c726afa01ec894ed8f455a5be43d275527e37c29" />
            </div>
        </div>
    </article>
);
