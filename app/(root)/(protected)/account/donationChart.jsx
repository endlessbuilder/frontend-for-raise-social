...
const DonationChart = () => {
    ...
    return (
        <div>
            <h1 className='uppercase text-5xl font-bold text-brand-dark mb-8 font-heading'>Donation Analytics</h1>
            {hasData
                ...
                : <div className='border border-dashed border-brand-dark rounded-xl h-[350px] flex flex-col gap-4 items-center justify-center'>
                    <h4 className='uppercase text-3xl font-bold text-brand-dark mb-8 font-heading'>No Data Yet</h4>
                </div>
            }
