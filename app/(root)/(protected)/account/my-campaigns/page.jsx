...
const mockData = [
    { id: 1, name: "Eco Fundraiser", category: "Environment", createdAt: "2023-08-15", goal: 10000, bannerImage: "/eco-banner.jpg", kycStatus: "Verified" },
    { id: 2, name: "Tech for Kids", category: "Education", createdAt: "2023-09-01", goal: 5000, bannerImage: "/tech-kids.jpg", kycStatus: "Pending" },
...
const CampaignDataTable = () => {
    ...
    const renderCell = (item, columnKey) => {
        ...
        switch (columnKey) {
            ...
            case "kycStatus":
                return (
                    <Chip className="capitalize" color={item.kycStatus === "Verified" ? "success" : "warning"} size="sm" variant="flat">
                        {cellValue}
                    </Chip>
                );
            case "actions":
                return (
                    <div className="relative flex items-center justify-center gap-2">
                        <Button size="sm" radius='full'>View</Button>
                        <Button size="sm" radius='full'>Edit</Button>
                    </div>
                );
            default:
                return cellValue;
