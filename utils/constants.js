// server_ip constant
export const SERVER_IP = process.env.REACT_APP_SERVER_IP; // || 'backend-for-raise-social.vercel.app';
export const FSERVER_IP = process.env.REACT_APP_FSERVER_IP; // || 'backend-for-raise-social.vercel.app';
